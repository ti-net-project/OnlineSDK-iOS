...
//  TOSClientKitDemo
//
//  Created by easemob on 2024/2/7.
...
- (void)NSMutableArray_Test_ObjectAtIndex {
    NSMutableArray *array = @[@"helloword"].mutableCopy;
...
- (void)NSMutableArray_Test_RemoveObjectAtIndex {
    NSMutableArray *array = @[@"helloword", @"iOSDeveloper"].mutableCopy;
...
- (void)NSMutableString_Test_ReplaceCharactersInRange {
    NSMutableString *strM = [NSMutableString stringWithFormat:@"helloword"];
    NSRange range = NSMakeRange(0, 1000);
