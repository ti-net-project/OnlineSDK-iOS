...
- (NSString *)tosURLEncoded {
    // 解码
    NSString *decoded = [self stringByRemovingPercentEncoding];
    // 重新编码
    NSCharacterSet *set = [NSCharacterSet URLQueryAllowedCharacterSet];
    NSLog(@"set =========== %@",set);
    NSString *encoded = [decoded stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet URLQueryAllowedCharacterSet]];
    return [self isEqualToString:encoded] ? self : encoded;
}
