...
//    } mutableCopy];
//    
//    quickEntryModel.params = [NSMutableDictionary dictionary];
//    
...
//        urlRegular.regular = @"((http[s]{0,1})://)(([a-zA-Z0-9\\._-]+\\.[a-zA-Z]{2,6})|([0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}))(:[0-9]{1,4})*(/[a-zA-Z0-9\\&%_\\./-~-]*)?";
        ...
        self.orderDrawer = [[TOSKitOrderDrawerHelper alloc] init];
        self.orderDrawer.drawerCorner = 20.0f;
        self.orderDrawer.logoCorner = 10.0f;
        self.orderDrawer.orderCorner = 8.0f;
        self.orderDrawer.listBackGroundColor = TOSHexColor(0xF5F5F5);
        self.orderDrawer.backGroundColor = TOSHexColor(0xFFFFFF);
        self.orderDrawer.productIconCorner = 6.0f;
