 ...
 */
@interface TIMYYWebImageManager : NSObject
 ...
 */
- (instancetype)initWithCache:(nullable TIMYYImageCache *)cache
 ...
 */
@property (nullable, nonatomic, strong) TIMYYImageCache *cache;
