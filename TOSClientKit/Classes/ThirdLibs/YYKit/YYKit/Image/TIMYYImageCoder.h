 ...
 */
@interface TIMYYImageFrame : NSObject <NSCopying>
 ...
 */
@interface TIMYYImageDecoder : NSObject
 ...
 */
- (nullable TIMYYImageFrame *)frameAtIndex:(NSUInteger)index decodeForDisplay:(BOOL)decodeForDisplay;
 ...
 */
@interface TIMYYImageEncoder : NSObject
...
/**
 ...
 @return The image data, or nil if an error occurs.
 */
+ (nullable NSData *)encodeImageWithDecoder:(TIMYYImageDecoder *)decoder type:(YYImageType)type quality:(CGFloat)quality;
