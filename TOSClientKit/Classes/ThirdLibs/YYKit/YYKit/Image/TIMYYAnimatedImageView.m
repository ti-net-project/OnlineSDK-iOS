...
@interface TIMYYAnimatedImageView() {
    @package
...
@property (nonatomic, weak) TIMYYAnimatedImageView *view;
...
- (void)main {
    __strong TIMYYAnimatedImageView *view = _view;
    if (!view) return;
...
@implementation TIMYYAnimatedImageView
...
- (void)resetAnimated {
    dispatch_once(&_onceToken, ^{
        ...
        _link = [CADisplayLink displayLinkWithTarget:[TIMYYWeakProxy proxyWithTarget:self] selector:@selector(step:)];
        if (_runloopMode) {
