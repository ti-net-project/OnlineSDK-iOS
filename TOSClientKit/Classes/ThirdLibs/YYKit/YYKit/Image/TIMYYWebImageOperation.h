 ...
 */
@interface TIMYYWebImageOperation : NSOperation
...
@property (nullable, nonatomic, strong, readonly) TIMYYImageCache      *cache;    ///< The image cache.
...
- (instancetype)initWithRequest:(NSURLRequest *)request
                        options:(YYWebImageOptions)options
                          cache:(nullable TIMYYImageCache *)cache
