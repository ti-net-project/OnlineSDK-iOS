 ...
 */
@interface TIMYYFileHash : NSObject
 ...
 */
+ (nullable TIMYYFileHash *)hashForFile:(NSString *)filePath types:(YYFileHashType)types;
...
/**
 ...
 @return File hash result, or nil when an error occurs.
 */
+ (nullable TIMYYFileHash *)hashForFile:(NSString *)filePath
