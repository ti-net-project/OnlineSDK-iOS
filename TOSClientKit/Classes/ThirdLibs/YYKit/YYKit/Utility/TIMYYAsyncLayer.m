...
@implementation TIMYYAsyncLayerDisplayTask
@end


@implementation TIMYYAsyncLayer {
    TIMYYSentinel *_sentinel;
}
...
- (void)_displayAsync:(BOOL)async {
    ...
    if (async) {
        if (task.willDisplay) task.willDisplay(self);
        TIMYYSentinel *sentinel = _sentinel;
