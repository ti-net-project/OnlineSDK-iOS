 ...
 */
@interface TIMYYGestureRecognizer : UIGestureRecognizer
...
@property (nullable, nonatomic, copy) void (^action)(TIMYYGestureRecognizer *gesture, YYGestureRecognizerState state);
