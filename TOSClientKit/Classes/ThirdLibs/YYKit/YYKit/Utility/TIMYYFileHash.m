...
@implementation TIMYYFileHash

+ (TIMYYFileHash *)hashForFile:(NSString *)filePath types:(YYFileHashType)types {
    return [self hashForFile:filePath types:types usingBlock:nil];
}

+ (TIMYYFileHash *)hashForFile:(NSString *)filePath types:(YYFileHashType)types usingBlock:(void(^)(UInt64 totalSize, UInt64 processedSize, BOOL *stop))block {
    TIMYYFileHash *hash = nil;
