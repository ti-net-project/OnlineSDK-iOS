...
- (BOOL)textView:(TIMYYTextView *)textView shouldChangeTextInRange:(NSRange)range replacementText:(NSString *)text;
- (void)textViewDidChange:(TIMYYTextView *)textView;
- (void)textViewDidChangeSelection:(TIMYYTextView *)textView;

- (BOOL)textView:(TIMYYTextView *)textView shouldTapHighlight:(TIMYYTextHighlight *)highlight inRange:(NSRange)characterRange;
- (void)textView:(TIMYYTextView *)textView didTapHighlight:(TIMYYTextHighlight *)highlight inRange:(NSRange)characterRange rect:(CGRect)rect;
- (BOOL)textView:(TIMYYTextView *)textView shouldLongPressHighlight:(TIMYYTextHighlight *)highlight inRange:(NSRange)characterRange;
- (void)textView:(TIMYYTextView *)textView didLongPressHighlight:(TIMYYTextHighlight *)highlight inRange:(NSRange)characterRange rect:(CGRect)rect;
@end
 ...
 */
@interface TIMYYTextView : UIScrollView <UITextInput>
 ...
 */
@property (nullable, nonatomic, strong, readonly) TIMYYTextLayout *textLayout;
 ...
 */
@property (nullable, nonatomic, copy) TIMYYTextDebugOption *debugOption;
