...
- (void)reloadBounds {
    ...
    for (NSUInteger r = 0; r < runCount; r++) {
        ...
        TIMYYTextAttachment *attachment = attrs[YYTextAttachmentAttributeName];
        if (attachment) {
