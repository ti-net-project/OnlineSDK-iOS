...
@implementation TIMYYTextContainerView {
...
- (void)setLayout:(TIMYYTextLayout *)layout {
...
- (void)setLayout:(TIMYYTextLayout *)layout withFadeDuration:(NSTimeInterval)fadeDuration {
...
- (void)drawRect:(CGRect)rect {
    ...
    if (_attachmentChanged) {
        ...
        for (TIMYYTextAttachment *a in _layout.attachments) {
