 ...
 */
@interface TIMYYTextContainerView : UIView
...
@property (nullable, nonatomic, strong) TIMYYTextLayout *layout;
...
- (void)setLayout:(nullable TIMYYTextLayout *)layout withFadeDuration:(NSTimeInterval)fadeDuration;
