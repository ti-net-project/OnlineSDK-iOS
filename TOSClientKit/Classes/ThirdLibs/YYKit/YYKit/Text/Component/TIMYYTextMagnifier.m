...
@interface _YYTextMagnifierCaret : TIMYYTextMagnifier {
...
@interface _YYTextMagnifierRanged : TIMYYTextMagnifier {
    UIImageView *_contentView;
    UIImageView *_coverView;
}
@end
...
@implementation TIMYYTextMagnifier
...
- (id)initWithFrame:(CGRect)frame {
    // class cluster
    if ([self isMemberOfClass:[TIMYYTextMagnifier class]]) {
