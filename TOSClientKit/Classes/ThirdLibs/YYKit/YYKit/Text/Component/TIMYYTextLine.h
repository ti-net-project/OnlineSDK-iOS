 ...
 */
@interface TIMYYTextLine : NSObject
...
@property (nullable, nonatomic, readonly) NSArray<TIMYYTextAttachment *> *attachments; ///< YYTextAttachment
 ...
 */
@interface TIMYYTextRunGlyphRange : NSObject
