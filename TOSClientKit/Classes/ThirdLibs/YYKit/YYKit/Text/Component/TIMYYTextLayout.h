...
/**
 ...
 Example:
     ...
     └─────────────────────────────┘
 */
@interface TIMYYTextContainer : NSObject <NSCoding, NSCopying>
 ...
 */
- (void)modifyLines:(NSArray<TIMYYTextLine *> *)lines fromText:(NSAttributedString *)text inContainer:(TIMYYTextContainer *)container;
@end
...
/**
 ...
 example: (layout with a circle exclusion path)
     ...
     └──────────────────────────┘
 */
@interface TIMYYTextLayout : NSObject <NSCoding>
...
*/
+ (nullable TIMYYTextLayout *)layoutWithContainerSize:(CGSize)size
...
/**
 ...
 @return A new layout, or nil when an error occurs.
 */
+ (nullable TIMYYTextLayout *)layoutWithContainer:(TIMYYTextContainer *)container
                                          text:(NSAttributedString *)text;
 ...
 */
+ (nullable NSArray<TIMYYTextLayout *> *)layoutWithContainers:(NSArray<TIMYYTextContainer *> *)containers
                                                      text:(NSAttributedString *)text;
...
///< The text container
@property (nonatomic, strong, readonly) TIMYYTextContainer *container;
///< The full text
...
@property (nonatomic, strong, readonly) NSArray<TIMYYTextLine *> *lines;
///< YYTextLine with truncated token, or nil
@property (nullable, nonatomic, strong, readonly) TIMYYTextLine *truncatedLine;
///< Array of `YYTextAttachment`
@property (nullable, nonatomic, strong, readonly) NSArray<TIMYYTextAttachment *> *attachments;
 ...
 */
- (nullable TIMYYTextPosition *)closestPositionToPoint:(CGPoint)point;
...
/**
 ...
 @return A text position, or nil if not found.
 */
- (nullable TIMYYTextPosition *)positionForPoint:(CGPoint)point
 ...
 */
- (nullable TIMYYTextRange *)textRangeAtPoint:(CGPoint)point;
...
/**
 ...
 at point. Or nil if not found.
 */
- (nullable TIMYYTextRange *)closestTextRangeAtPoint:(CGPoint)point;
 ...
 */
- (nullable TIMYYTextRange *)textRangeByExtendingPosition:(TIMYYTextPosition *)position;
 ...
 */
- (NSArray<TIMYYTextSelectionRect *> *)selectionRectsForRange:(TIMYYTextRange *)range;
...
/**
 ...
 If not found, the array is empty.
 */
- (NSArray<TIMYYTextSelectionRect *> *)selectionRectsWithoutStartAndEndForRange:(TIMYYTextRange *)range;
 ...
 */
- (NSArray<TIMYYTextSelectionRect *> *)selectionRectsWithOnlyStartAndEndForRange:(TIMYYTextRange *)range;
...
- (void)drawInContext:(nullable CGContextRef)context
                ...
                debug:(nullable TIMYYTextDebugOption *)debug
