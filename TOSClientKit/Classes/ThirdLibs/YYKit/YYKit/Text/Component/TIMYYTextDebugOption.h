...
@class TIMYYTextDebugOption;

NS_ASSUME_NONNULL_BEGIN

/**
 The TIMYYTextDebugTarget protocol defines the method a debug target should implement.
 A debug target can be add to the global container to receive the shared debug
 option changed notification.
 */
@protocol TIMYYTextDebugTarget <NSObject>
 ...
 */
- (void)setDebugOption:(nullable TIMYYTextDebugOption *)option;
@end
 ...
 */
@interface TIMYYTextDebugOption : NSObject <NSCopying>
 ...
 */
+ (nullable TIMYYTextDebugOption *)sharedDebugOption;
 ...
 */
+ (void)setSharedDebugOption:(nullable TIMYYTextDebugOption *)option;
