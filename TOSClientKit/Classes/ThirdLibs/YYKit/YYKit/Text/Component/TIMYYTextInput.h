 ...
 */
@interface TIMYYTextPosition : UITextPosition <NSCopying>
...
/**
 ...
 so you can alse use it to interact with UITextView/UITextField.
 */
@interface TIMYYTextRange : UITextRange <NSCopying>

@property (nonatomic, readonly) TIMYYTextPosition *start;
@property (nonatomic, readonly) TIMYYTextPosition *end;
...
/**
 ...
 so you can alse use it to interact with UITextView/UITextField.
 */
@interface TIMYYTextSelectionRect : UITextSelectionRect <NSCopying>
