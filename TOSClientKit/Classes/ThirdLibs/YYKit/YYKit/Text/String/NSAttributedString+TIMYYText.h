 ...
 */
@interface NSAttributedString (TIMYYText)
...
/**
 ...
 @since YYKit:6.0
 */
@property (nullable, nonatomic, strong, readonly) TIMYYTextShadow *textShadow;
- (nullable TIMYYTextShadow *)textShadowAtIndex:(NSUInteger)index;
...
/**
 ...
 @since YYKit:6.0
 */
@property (nullable, nonatomic, strong, readonly) TIMYYTextShadow *textInnerShadow;
- (nullable TIMYYTextShadow *)textInnerShadowAtIndex:(NSUInteger)index;
...
/**
 ...
 @since YYKit:6.0
 */
@property (nullable, nonatomic, strong, readonly) TIMYYTextDecoration *textUnderline;
- (nullable TIMYYTextDecoration *)textUnderlineAtIndex:(NSUInteger)index;
...
/**
 ...
 @since YYKit:6.0
 */
@property (nullable, nonatomic, strong, readonly) TIMYYTextDecoration *textStrikethrough;
- (nullable TIMYYTextDecoration *)textStrikethroughAtIndex:(NSUInteger)index;
...
/**
 ...
 @since YYKit:6.0
 */
@property (nullable, nonatomic, strong, readonly) TIMYYTextBorder *textBorder;
- (nullable TIMYYTextBorder *)textBorderAtIndex:(NSUInteger)index;
...
/**
 ...
 @since YYKit:6.0
 */
@property (nullable, nonatomic, strong, readonly) TIMYYTextBorder *textBackgroundBorder;
- (nullable TIMYYTextBorder *)textBackgroundBorderAtIndex:(NSUInteger)index;
...
/**
 ...
 @since YYKit:6.0
 */
@property (nullable, nonatomic, strong, readwrite) TIMYYTextShadow *textShadow;
- (void)setTextShadow:(nullable TIMYYTextShadow *)textShadow range:(NSRange)range;
...
/**
 ...
 @since YYKit:6.0
 */
@property (nullable, nonatomic, strong, readwrite) TIMYYTextShadow *textInnerShadow;
- (void)setTextInnerShadow:(nullable TIMYYTextShadow *)textInnerShadow range:(NSRange)range;
...
/**
 ...
 @since YYKit:6.0
 */
@property (nullable, nonatomic, strong, readwrite) TIMYYTextDecoration *textUnderline;
- (void)setTextUnderline:(nullable TIMYYTextDecoration *)textUnderline range:(NSRange)range;
...
/**
 ...
 @since YYKit:6.0
 */
@property (nullable, nonatomic, strong, readwrite) TIMYYTextDecoration *textStrikethrough;
- (void)setTextStrikethrough:(nullable TIMYYTextDecoration *)textStrikethrough range:(NSRange)range;
...
/**
 ...
 @since YYKit:6.0
 */
@property (nullable, nonatomic, strong, readwrite) TIMYYTextBorder *textBorder;
- (void)setTextBorder:(nullable TIMYYTextBorder *)textBorder range:(NSRange)range;
...
/**
 ...
 @since YYKit:6.0
 */
@property (nullable, nonatomic, strong, readwrite) TIMYYTextBorder *textBackgroundBorder;
- (void)setTextBackgroundBorder:(nullable TIMYYTextBorder *)textBackgroundBorder range:(NSRange)range;
...
- (void)setTextBackedString:(nullable TIMYYTextBackedString *)textBackedString range:(NSRange)range;
- (void)setTextBinding:(nullable TIMYYTextBinding *)textBinding range:(NSRange)range;
- (void)setTextAttachment:(nullable TIMYYTextAttachment *)textAttachment range:(NSRange)range;
- (void)setTextHighlight:(nullable TIMYYTextHighlight *)textHighlight range:(NSRange)range;
- (void)setTextBlockBorder:(nullable TIMYYTextBorder *)textBlockBorder range:(NSRange)range;
- (void)setTextRubyAnnotation:(nullable TIMYYTextRubyAnnotation *)ruby range:(NSRange)range NS_AVAILABLE_IOS(8_0);
