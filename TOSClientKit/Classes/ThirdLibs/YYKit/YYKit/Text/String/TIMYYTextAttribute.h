 ...
 */
@interface TIMYYTextBackedString : NSObject <NSCoding, NSCopying>
...
/**
 ...
 selection and edit.
 */
@interface TIMYYTextBinding : NSObject <NSCoding, NSCopying>
 ...
 */
@interface TIMYYTextShadow : NSObject <NSCoding, NSCopying>
...
@property (nullable, nonatomic, strong) TIMYYTextShadow *subShadow;  ///< a sub shadow which will be added above the parent shadow
 ...
 */
@interface TIMYYTextDecoration : NSObject <NSCoding, NSCopying>
...
@property (nullable, nonatomic, strong) TIMYYTextShadow *shadow;  ///< line shadow
@end
...
/**
 ...
 Example:
    ...
    ╰──────╯
 */
@interface TIMYYTextBorder : NSObject <NSCoding, NSCopying>
...
@property (nullable, nonatomic, strong) TIMYYTextShadow *shadow; ///< border shadow
 ...
 */
@interface TIMYYTextAttachment : NSObject<NSCoding, NSCopying>
 ...
 */
@interface TIMYYTextHighlight : NSObject <NSCoding, NSCopying>
...
- (void)setShadow:(nullable TIMYYTextShadow *)shadow;
- (void)setInnerShadow:(nullable TIMYYTextShadow *)shadow;
- (void)setUnderline:(nullable TIMYYTextDecoration *)underline;
- (void)setStrikethrough:(nullable TIMYYTextDecoration *)strikethrough;
- (void)setBackgroundBorder:(nullable TIMYYTextBorder *)border;
- (void)setBorder:(nullable TIMYYTextBorder *)border;
- (void)setAttachment:(nullable TIMYYTextAttachment *)attachment;
