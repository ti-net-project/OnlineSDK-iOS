...
static void DeallocCallback(void *ref) {
    TIMYYTextRunDelegate *self = (__bridge_transfer TIMYYTextRunDelegate *)(ref);
    self = nil; // release
}

static CGFloat GetAscentCallback(void *ref) {
    TIMYYTextRunDelegate *self = (__bridge TIMYYTextRunDelegate *)(ref);
    return self.ascent;
}
...
@implementation TIMYYTextRunDelegate
