...
/// 订单抽屉
- (void) chatBoxViewController:(TIMChatBoxViewController *)chatboxViewController
              orderItem:(ICChatBoxMoreViewItem *)item;

/// 跳转外链
/// - Parameters:
///   - chatboxViewController: 输入区域的控制器
///   - item: 对应的扩展面板的item
///   - model: 对应的扩展面板的item的model
- (void) chatBoxViewController:(TIMChatBoxViewController *)chatboxViewController
              withItem:(ICChatBoxMoreViewItem *)item withModel:(TOSKitExtendBoardItemModel *)model;

/// 满意度
/// - Parameters:
///   - chatboxViewController: 输入区域的控制器
///   - satisfactionItem: 对应的扩展面板的满意度item
- (void) chatBoxViewController:(TIMChatBoxViewController *)chatboxViewController
                    withSatisfactionItem:(ICChatBoxMoreViewItem *)satisfactionItem;
